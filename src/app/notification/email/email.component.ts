...
import { BlockUserComponent } from 'src/app/model/block-user/block-user.component';
import { DeleteUserComponent } from 'src/app/model/delete-user/delete-user.component';
import { ServicesService } from 'src/app/service/services.service';
import { TosterService } from 'src/app/toster/toster.service';
...
@ViewChild('rightDrawer', { static: false }) sideNav: MatSidenav;
  ...
  selectTenentForEmail = (value: any) => {
    console.log(value)
         const data = {
        Tenant_ID: value
      }
